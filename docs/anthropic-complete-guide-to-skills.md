...
#### Focus on outcomes, not features:#### ✅ Good:
...
#### Solutions:#### 1. Add negative triggers
...
_Note: Adding this to user prompts is more effective than in SKILL.md_
...
- [Best Practices Guide](https://github.com/anthropic/agent-skills/blob/main/docs/best-practices.md)
- [Skills Documentation](https://github.com/anthropic/agent-skills)
- [API Reference](https://github.com/anthropic/agent-skills/blob/main/docs/api-reference.md)
- [MCP Documentation](https://github.com/anthropic/agent-skills/blob/main/docs/mcp-documentation.md)

#### Blog Posts

- [Introducing Agent Skills](https://github.com/anthropic/agent-skills/blob/main/docs/introducing-agent-skills.md)
- [Engineering Blog: Equipping Agents for the Real World](https://github.com/anthropic/agent-skills/blob/main/docs/engineering-blog.md)
- [Skills Explained](https://github.com/anthropic/agent-skills/blob/main/docs/skills-explained.md)
- [How to Create Skills for Claude](https://github.com/anthropic/agent-skills/blob/main/docs/how-to-create-skills.md)
- [Building Skills for Claude Code](https://github.com/anthropic/agent-skills/blob/main/docs/building-skills-for-claude-code.md)
- [Improving Frontend Design through Skills](https://github.com/anthropic/agent-skills/blob/main/docs/improving-frontend-design.md)

### Example skills

#### Public skills repository

- GitHub: [anthropics/skills](https://github.com/anthropic/agent-skills/tree/main/skills)
...
- General questions: Community forums at the [Claude Developers Discord](https://github.com/anthropic/agent-skills/blob/main/docs/getting-support.md)

#### For Bug Reports

- GitHub Issues: [anthropics/skills/issues](https://github.com/anthropic/agent-skills/issues)
...
- **[Document Skills](https://github.com/anthropic/agent-skills/tree/main/skills/document-skills)** — PDF, DOCX, PPTX, XLSX creation
- **[Example Skills](https://github.com/anthropic/agent-skills/tree/main/skills)** — Various workflow patterns
